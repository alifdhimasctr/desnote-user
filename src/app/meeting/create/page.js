...
export default function CreateMeet() {
  ...
  const handleCreateMeet = async (e) => {
    ...
    const response = await axios.post(
      process.env.NEXT_PUBLIC_BASE_URL + "/meet/create-meet",
      {
        ...
        fileAttachment: fileData[0].fileAttachment,
  ...
  console.log(formData.fileAttachment);
            ...
            <form 
              ...
              <div>
                ...
                <input
                  ...
                  required
                  onChange={(e) => setFormData({ ...formData, meetTitle: e.target.value })}
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  required
                  onChange={(e) => setFormData({ ...formData, meetDate: new Date(e.target.value).toISOString()})}
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select
                  ...
                  isSearchable={true}
                  isRequired={true}
                  onChange={(e) => setFormData({ ...formData, users: e.map((person) => person.value) })}
                ></Select>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="w-1/4 p-2 bg-white shadow-md rounded-lg"
                  required
                  onChange={(e) => setFormData({ ...formData, meetReminder: e.target.value })}
                />
              </div>

              <button
                type="submit"
                className="w-max p-2 px-3 bg-blue-500 text-white rounded-lg">
                Create
              </button>
            </form>
          </div>
